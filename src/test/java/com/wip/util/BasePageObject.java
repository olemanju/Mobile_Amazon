...
public class BasePageObject
{
    ...
    public MobileElement findElementByText(String text) {
        try {
            MobileElement element = ((AndroidDriver<MobileElement>)driver).findElementByAndroidUIAutomator("new UiSelector().textContains(\""+text+"\")");
     ...
     */
    public void scrollTillVisible(String text)
    {
